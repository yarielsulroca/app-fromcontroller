        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                ...
                <div class="d-flex justify-content-center gap-3 flex-wrap">
                    ...
                    <a href="<?php echo $this->url('contacto'); ?>" class="btn btn-outline-primary btn-lg">
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-12">
                ...
                <div class="d-flex justify-content-center gap-3 flex-wrap">
                    <a href="<?php echo $this->url('home'); ?>" class="btn btn-outline-secondary">
                        <i class="fas fa-info-circle"></i> Home
                    </a>
                    <a href="<?php echo $this->url('ingreso'); ?>" class="btn btn-outline-secondary">
                        <i class="fas fa-info-circle"></i> Ingreso
                    </a>
                    <a href="<?php echo $this->url('registro'); ?>" class="btn btn-outline-secondary">
                        <i class="fas fa-cogs"></i> Registro
                    </a>
                    <a href="<?php echo $this->url('contacto'); ?>" class="btn btn-outline-secondary">
